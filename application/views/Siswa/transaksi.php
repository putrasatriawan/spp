                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools">
                            <a class=" btn btn-sm btn-primary shadow-sm" href="<?= base_url('siswa/siswa'); ?>" onclick="return confirm('Silahkan pilih siswa yang ingin ditambahkan data transaksi');">
                                ...
                                <?php foreach ($transaksi as $t) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?= base_url('siswa/print/') . $t['id']; ?>    " class="badge badge-success" onclick="return confirm('apakah anda yakin ingin mengprint data ini?');">
