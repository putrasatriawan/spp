                    ...
                    <div class="card-header">
                        <div class="card-tools">
                            <a class=" btn btn-sm btn-primary shadow-sm" href="<?= base_url('siswa/tambahsiswa'); ?>">
                                <i class=" fas fa-user-plus fa-sm"></i> Tambah Siswa
                            </a>
                        </div>
                ...
                <div class="modal-body">
                    <div class="col-lg">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nik" value="<?= $s['nik']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nok">Nik</label>
                            <input type="text" class="form-control" id="nok" value="<?= $s['nok']; ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_siswa" value="<?= $s['jenis_kelamin']; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_ayah" value="<?= $s['nama_ayah']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nama_ibu">Nama Ibu</label>
                            <input type="text" class="form-control" id="nama_ibu" value="<?= $s['nama_ibu']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="alamat_ortu">Alamat Lengkap Orang Tua</label>
                            <textarea class="form-control" id="alamat_ortu" rows="3"><?= $s['alamat_ortu']; ?></textarea readonly>
                        </div>
                    </div>
                </div>
